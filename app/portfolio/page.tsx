...
export const metadata: Metadata = {
  title: "Portfolio — Nova Studio",
  description: "Browse Nova Studio's portfolio of premium custom design and Next.js front-end projects.",
};
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative pt-[180px] pb-[220px] overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center">
          <FadeUp>
            <p className="text-xs uppercase tracking-[0.3em] text-primary font-bold mb-[16px]">Our Work</p>
          </FadeUp>
          {/* H1 style: text-[72px] */}
          <AnimatedText
            text="Featured Custom Web Projects"
          ...
          <FadeUp delay={0.25}>
            <p className="text-muted text-[20px] leading-[1.7] max-w-[650px] mx-auto">
              A curated showcase of clean visual designs and high-performance interfaces coded from scratch.
            </p>
          </FadeUp>
        </div>
      </section>
